...
<div class="container">
  <div id="Checkout" class="inline">
      ...
      <form name="myForm" method="POST" action="paymentquery.php" onsubmit="return validateForm()">
  ...
  <tr> 
    ...
    <td colspan="2" align="left">
      <SELECT NAME="CCExpiresMonth" id="CCExpiresMonth" >
        <OPTION VALUE="try" SELECTED>--Month--
...
function validateForm() {
    ...
    var y1 = document.forms["myForm"]["ZIPCode"].value;
    if ((y1%1) != 0){
    ...
    var z2 = document.forms["myForm"]["CreditCardNumber"].value;
    if ((z2%1) != 0){
        alert("Credit Crad must be numbers only");
        return false;
    }
    ...
    var w2 = document.forms["myForm"]["SecurityCode"].value;
    if ((w2%1) != 0){
        alert("CVV number must be numbers only");
        return false;
    }
}
</script>
...
<script src='http://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/js/bootstrap.min.js'></script>
    ...
    <script src="js/pay_index.js"></script>
